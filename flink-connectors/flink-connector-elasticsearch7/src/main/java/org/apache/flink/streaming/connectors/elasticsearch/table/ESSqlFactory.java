...
public class ESSqlFactory implements DynamicTableSourceFactory {
    ...
    public static final ConfigOption<String> DOCUMENT_TYPE =
            ConfigOptions.key("document-type").stringType().noDefaultValue();
    public static final ConfigOption<String> FORMAT =
            ConfigOptions.key("format").stringType().noDefaultValue();
    public static final ConfigOption<Integer> FETCH_SIZE =
            ConfigOptions.key("fetch_size").intType().noDefaultValue();
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        final DataType producedDataType =
                context.getCatalogTable().getSchema().toPersistedRowDataType();

        return new ESDynamicTableSource(
                hosts,
                username,
                password,
                index,
